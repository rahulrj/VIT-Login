...
public class DBAdapterlinks
{
	...
	private static final String DATABASE_TABLE = "link";
	...
	public DBAdapterlinks(Context ctx)
	{
	...
	public static final String DATABASE_CREATE="Create Table links(link varchar2(1000))";
	...
	{
	System.out.println("in calendar table oncreate outer");	
	try {
		db.execSQL(DATABASE_CREATE);
		
		System.out.println("In calendar tabe oncreate inner");
	...
	public  void insertContact(String link)
			
	{
	System.out.println("In inserting contact of links values");	
	...
	public DBAdapterlinks open() throws SQLException
	{
	...
	*/
	...
	public Cursor getAllContacts()
	{
		System.out.println("in getallcontacts of calendar table");
