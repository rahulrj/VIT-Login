...
public class Attendanceboth extends Activity  implements ScrollViewListener ,ScrollViewListener2
{
	String[] course_title;
 ...
 for( i=0;i<length_dates;i++)
 {
	...
	//	   dat22[j][i].setTextColor(getResources().getColor(android.R.color.black));
