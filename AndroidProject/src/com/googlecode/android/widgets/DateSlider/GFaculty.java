...
public class GFaculty
{
	public static final String KEY_DATES="dates";
	

	private static final String TAG = "DBAdapter";
	private static final String DATABASE_NAME = "gFaculty_database";
	private static final String DATABASE_TABLE = "gattend2";
	private static final int DATABASE_VERSION = 1;
	static String date="dates";
	static String querystring;
	static String DATABASE_CREATE;
	static String subs[]={"rahul","raja","hass","awesome"};
	static String tablename="gattend2";
	...
	return x;
		...
		public GFaculty open() throws SQLException
	{
	...
	querystring =date+" VARCHAR(30) unique ,";
		Log.d("dat is",date);
		int k;
		int length=global.guestsubjects.length;
		for( k=0;k<length-1;k++)
		{
			querystring += global.guestsubjects[k];
            querystring +=" VARCHAR(200)";
            querystring +=",";
		}
		 querystring+= global.guestsubjects[length-1] +" VARCHAR(200)";
