...
public class GMarks extends Activity implements ScrollViewListener ,ScrollViewListener2
{
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
	    ...
	    for(int  j=0;j<length_subjects;j++)
		{
		   ...
		   marks_quiz1[j]=new TextView(getApplicationContext());
		    ...
		    marks_quiz1[j].setPadding(5, 5, 5, 5);
		    ...
		    marks_quiz2[j].setPadding(5, 5, 5, 5);
		    ...
		    marks_quiz3[j].setPadding(5, 5, 5, 5);
		    ...
		    marks_cat1[j].setPadding(5, 5, 5, 5);
		   marks_cat1[j].setText(cat1[j]);
		    ...
		    marks_cat2[j].setPadding(5, 5, 5, 5);
		    ...
		    marks_assn[j].setPadding(5, 5, 5, 5);
		  ...
		  space6.setLayoutParams(new LayoutParams(1,LayoutParams.MATCH_PARENT));
		   space6.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
		marks_linear[j].addView(space6);
		
		  marks_linear[j].addView(marks_quiz2[j]);
		  TextView space1=new TextView(this);
		  space1.setLayoutParams(new LayoutParams(1,LayoutParams.MATCH_PARENT));
		   space1.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
		marks_linear[j].addView(space1);
	
		  marks_linear[j].addView(marks_quiz3[j]);
		  TextView space2=new TextView(this);
		  space2.setLayoutParams(new LayoutParams(1,LayoutParams.MATCH_PARENT));
		   space2.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
		marks_linear[j].addView(space2);
	
		  marks_linear[j].addView(marks_cat1[j]);
		  TextView space3=new TextView(this);
		  space3.setLayoutParams(new LayoutParams(1,LayoutParams.MATCH_PARENT));
		   space3.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
		marks_linear[j].addView(space3);
	
		  marks_linear[j].addView(marks_cat2[j]);
		  TextView space4=new TextView(this);
		  space4.setLayoutParams(new LayoutParams(1,LayoutParams.MATCH_PARENT));
		   space4.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
		marks_linear[j].addView(space4);
	
		  marks_linear[j].addView(marks_assn[j]);
		  TextView space5=new TextView(this);
		  space5.setLayoutParams(new LayoutParams(1,LayoutParams.MATCH_PARENT));
		   space5.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
		marks_linear[j].addView(space5);
